              ...
              {groups.map((group) => (
                ...
                >
                  <div className="h-28 w-full bg-neutral-800 relative overflow-hidden">
                    <Image width={0} height={0} src={group.cover} alt="Cover" className="w-full h-full object-cover group-hover/card:scale-105 transition-transform duration-700 opacity-80" />
