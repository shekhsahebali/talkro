...
const HomePage = () => {
  ...
  return (
    <div className="flex flex-col animate-in fade-in duration-500">
      <header className="sticky top-0 z-30 bg-background border-b border-border/8 px-4 py-4 flex justify-between items-center">
        ...
        <div>
          <Button variant="ghost" size="icon" className="rounded-full" onClick={handlemessage} ><MessageCircleMore className="w-6 h-6 bold" /></Button>
          <ThemeToggle />
        </div>
