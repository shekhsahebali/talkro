...
const Stories: React.FC<StoriesProps> = ({ stories }) => {
  ...
  const onViewStory = (story: Story) => {
    console.log(story);
    setShowStoryViewer(true);
    setInitialStoryId(story.id);
     
  }

  return (
    <div className="border-b border-border overflow-x-auto no-scrollbar py-6 px-4 flex items-center space-x-4 bg-background/40">
      ...
      {showStoryViewer && <StoryViewer stories={stories} initialStoryId={initialStoryId} onClose={() => setShowStoryViewer(false)} />}
